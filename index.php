<?php get_header(); ?>
	...
	<article>
		...
		<header class="entry-header">
			<h1>Bestwebsite Options Framework Theme</h1>
		...
		<div class="entry-content">
			...
			<p>This is the adapted theme version of the Bestwebsite Options Framework plugin, which makes it easy to include an options panel for any theme.</p>
